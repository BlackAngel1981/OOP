...
public class Program {
 ...
 public static void main(String[] args) {
  ...
  Product chocolate = new Chocolate("Бабаевский", "Аленка", 100, 550);
  System.out.println(chocolate .displayInfo());
  Product chocolate1 = new Chocolate("Бабаевский", "Милка", 120, 540);
  System.out.println(chocolate1 .displayInfo());
  Product chocolate2 = new Chocolate("Красный Октябрь", "Аленка", 90, 560);
  ...
  Chocolate chocolate3 = vendingMachine.getChocolate("chocolate", 560);
  if (chocolate != null){
   System.out.println("Вы купили:");
   System.out.println(chocolate.displayInfo());
  }
